import{r as P,R as S,u as ei,j as ue}from"./index-Cb-TbwQD.js";var $n={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qs="storage";function zu(t=Vr(),e){t=Pe(t);const r=wn(t,Qs).getImmediate({identifier:e}),s=ci("storage");return s&&Wu(r,...s),r}function Wu(t,e,n,r={}){ju(t,e,n,r)}function qu(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new Vu(n,r,s,e,He)}function Gu(){Be(new Ae(Qs,qu,"PUBLIC").setMultipleInstances(!0)),be(Pr,Nr,""),be(Pr,Nr,"esm2017")}Gu();const Ku={apiKey:"AIzaSyDKmlvCw610NsX15yB79NHuCsEF7H4reqg",authDomain:"embergrove-f84a1.firebaseapp.com",projectId:"embergrove-f84a1",storageBucket:"embergrove-f84a1.appspot.com",messagingSenderId:"927241191480",appId:"1:927241191480:web:afacd64bff49249e7726cd",measurementId:"G-YX643CRG4C"},Bn=jr(Ku),Ju=Cc(Bn);zu(Bn);const Xu={app:Bn,auth:Ju},Yu="http://192.168.2.181:8080/api/v1";console.log(Yu);const Qu=async t=>{const e=new ee;e.setCustomParameters({login_hint:"user@example.com",prompt:"select_account"});const n=Xu.auth;n.useDeviceLanguage();const r=await Fa(n,e);return r?((await r.user.getIdTokenResult()).claims,t("/hello")):t("/login",{state:{error_message:"No response from Google. Try again."}})},ed=()=>{S.useState(""),S.useState("");const[t,e]=S.useState(void 0);S.useEffect(()=>{t&&k.error(t,{position:"top-center",autoClose:5e3,hideProgressBar:!0,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"colored",transition:Hc})},[]);const n=ei();return ue.jsxs("div",{children:[ue.jsx(Vc,{position:"top-center",autoClose:5e3,hideProgressBar:!0,newestOnTop:!0,closeOnClick:!0,rtl:!1,pauseOnFocusLoss:!0,draggable:!0,pauseOnHover:!0,theme:"colored"}),ue.jsxs("form",{children:[ue.jsx("label",{children:"Email"}),ue.jsx("input",{type:"email"}),ue.jsx("label",{children:"Password"}),ue.jsx("input",{type:"password"})]}),ue.jsx("button",{onClick:async()=>await Qu(n),children:"Sign in with google"})]})};export{ed as default};
